    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-slate-900 border border-slate-700 p-6 rounded-xl w-full max-w-lg relative">
        ...
        <input
          ...
          className="w-full bg-slate-800 border border-slate-700 rounded p-2 text-sm text-gray-300"
        />

        <button
          onClick={handleImport}
          disabled={loading || !file}
          className="w-full mt-4 py-2 rounded bg-blue-600 hover:bg-blue-500 text-white"
        >
