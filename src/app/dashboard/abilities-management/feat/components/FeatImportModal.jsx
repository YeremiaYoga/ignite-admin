...
export default function FeatImportModal({ onClose }) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API}/foundry/feats/import-files`, {
        method: "POST",
        body: formData,
        headers: {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-slate-900 border border-slate-700 p-6 rounded-2xl w-full max-w-lg relative shadow-2xl">
        ...
        <div
          ...
          onClick={() => document.getElementById("feat-json-input")?.click()}
        >
